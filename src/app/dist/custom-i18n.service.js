...
// =====================
var CustomI18nService = /** @class */ (function () {
    ...
    CustomI18nService.prototype.translate = function (moduleItem, items) {
        ...
        if (items)
            items.filter(function (e) { return !e.traducido; }).forEach(function (e) {
    ...
    CustomI18nService.prototype.get = function (key) {
        ...
        if (!map.has(key))
            throw "La llave '" + key + "' no se encuentra";
        return map.get(key);
    };
